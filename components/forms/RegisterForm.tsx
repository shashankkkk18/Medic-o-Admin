      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField
            ...
            placeholder="Mention your Current Medications"
          />
        </div>
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Mention your Family Medical History"
          />
          <CustomFormField
            fieldType={FormFieldType.TEXTAREA}
            control={form.control}
            ...
            placeholder="Mention your Past Medical History"
          />
        </div>
        ...
        <CustomFormField
          ...
          placeholder="Provide Identification Number"
        />
        ...
        <CustomFormField
          ...
          control={form.control}
          name="privacyConsent"
          label="I consent that I have reviewed and agree to the privacy policy."
        />
